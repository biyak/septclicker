        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Select the desired questions from below and click <i>Create</i> to create a quiz with the
                        selected questions.
                    </p>
                </div>
            </div>
        ...
        @foreach ($questions as $q)
            <div class="container">
                <div class="jumbotron questionjumbo" style="background: lightgrey" id="{{$q->id}}">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="question"><b>  {{$num}}. {{$q->question_text}} </b></div>
                            <br>
                            <div class="answers">
                                @if ($q->option_a != null)
            ...
            <div class="jumbotron" style="background: lightgrey" id="noQuestions">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p> To add a question to your test bank, select the "add to test bank" checkbox when creating or
                            editing a question. </p>
                    </div>
                </div>
            </div>
        </div>
