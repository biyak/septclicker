                    ...
                    <div>
                        ...
                        <div class="buttons" style="float:right;">
                            ...
                            <form action="" method="post" style="display:inline-block;">
                                ...
                                <input type="submit" class="btn btn-danger" name="delete_question" value="Delete"
                                       onclick="return confirm('Are you sure to delete the question?');"/>
                            </form>
                        </div>
                        <div>
