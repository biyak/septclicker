...
@section('content')
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <form action="/{{$question->quiz_id}}/question/{{$question->id}}" enctype="multipart/form-data"
                  method="post">
                <!--Variables-->
                @csrf
                @method('PATCH')
                    ...
                    <div id="questionsCont">
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input class="form-control" type="number"
                                       value="{{ old('timelimit') ?? $question->timelimit}}"
                                       placeholder="Allowed time (seconds)" name="timelimit">
                            </div>
                        </div>

                        <div class="row pb-3">
                            <label for="image" class="col-2 col-form-label text-center">Add Image</label>
                            <input type="file" class="col-4 form-control-file"
                                   value="{{ old('image') ?? $question->image}}" name="image" accept="image/*">
                        </div>
                        ...
                        <div id="typeCont">
                            ...
                            <div class="form-group row" style="padding-top:10px; padding-bottom:10px">
                                ...
                                <div class="col-9">
                                    <input class="form-control" type="text" name="option_a" placeholder="Option A"
                            ...
                            <div class="form-group row" style="padding-bottom:10px">
                                ...
                                <div class="col-3">
                                    <input class="form-control" max-length="1" type="text" placeholder="Correct Option"
                                           pattern="[ABCDEabcde]" name="question_ans"
                                           value="{{ old('question_ans') ?? $question->question_ans}}">
                                </div>
                                <div class="col-7">
                            ...
                            <div align="center">
                                <input class="form-control" type="checkbox" id="testbankadd" name="testbankadd"
                                       value="yes">
