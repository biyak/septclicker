...
@section('content')
        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <a href='../{{$quiz->id}}/question/create'>
                        ...
                        <div class="buttons" style="float:right;">
                            ...
                            <form action="" method="post" style="display:inline-block;">
                                ...
                                <button type="submit" id="delete" class="btn btn-danger"
                                        onclick="return confirm('Are you sure to delete the question?');">Delete
                                </button>
                            </form>
                        </div>
                        <div>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <form method="post" action="../{{$quiz->id}}/responses"
                  onclick="return confirm('Are you sure to launch the quiz?')">
                @csrf
