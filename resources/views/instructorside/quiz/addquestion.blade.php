                ...
                <div class="items whiteTxt" style="padding-bottom:20px" id="questionsCont">
                    ...
                    <div id="questionsCont">
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input class="form-control" type="number" placeholder="Allowed time (seconds)"
                                       name="timelimit">
                            </div>
                        </div>
                    ...
                    <div align="right">
                        <a href="../../instructorhome">
                            <button type="button" class="btn btn-secondary" id="saveExitBtn">Exit Quiz</button>
                        </a>
