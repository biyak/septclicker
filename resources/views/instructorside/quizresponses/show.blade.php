...
@section('content')
        ...
        <div class="jumbotron">
            ...
            @if ($active == 1)
                <form method="post" action=""
                      style="text-align:right;display:inline-block;padding-left: 15px;padding-right: 15px;"
                      onclick="return confirm('Are you sure to stop the quiz?');">
                    @csrf
            ...
            @if ($active == 0)
                <form method="post" action=""
                      style="text-align:right;display:inline-block;padding-left: 15px;padding-right: 15px;"
                      onclick="return confirm('Are you sure to start the quiz?');">
                    @csrf
                    <input type="submit" class="btn btn-success" name="start_button" value="Start Quiz"/>
                    @endif
                </form>
                <a href='responses/result'>
                    <button type="button" class="btn btn-secondary">
                        See Results
                    </button>
                </a>
                <form method="post" action="" style="text-align:right;display:inline-block;float:right;"
                      onclick="return confirm('Are you sure to DELETE the quiz?');">
                    @csrf
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            @if ($question->image !== null)
                                <img src="/storage/{{$question->image}}" width="150" height="100"
    ...
    <div class="container">
        <div class="jumbotron">
            <a href="/instructorquizlist/{{auth::user()->id}}">
