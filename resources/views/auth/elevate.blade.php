    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Instructors should have received a code to activate their accounts - if you have one, please enter it below.</p>
                    <form method="POST" action="/elevate">
                        ...
                        <div class="form-group row">
                            <label for="code" class="col-md-4 col-form-label text-md-right">{{ __('Elevation Code: ') }}</label>
